...
int main() {
  ...
  static boost::shared_ptr<Polytope_Rn> Cube;
  for (int i=0; i<1;i++){
	  callPolitopix();
  }
  clock_t end = clock();
...
void callPolitopix(){
	  ...
	  static boost::shared_ptr<Polytope_Rn> Cube(new Polytope_Rn());
	  static boost::shared_ptr<Generator_Rn> VX0(new Generator_Rn(dimension));
	  static boost::shared_ptr<Generator_Rn> VX1(new Generator_Rn(dimension));
	  static boost::shared_ptr<Generator_Rn> VX2(new Generator_Rn(dimension));
	  static boost::shared_ptr<Generator_Rn> VX3(new Generator_Rn(dimension));
	  static boost::shared_ptr<Generator_Rn> VX4(new Generator_Rn(dimension));
	  ...
	  VX0->setCoordinate(3, 0.0); VX0->setCoordinate(4, 0.0); VX0->setCoordinate(5, 0.0);
	  ...
	  VX3->setCoordinate(3, 0.0); VX3->setCoordinate(4, 0.0); VX3->setCoordinate(5, 0.0);
	  VX4->setCoordinate(3, 0.0); VX4->setCoordinate(4, 0.0); VX4->setCoordinate(5, 0.0);

	  Cube->addGenerator(VX0); Cube->addGenerator(VX1); Cube->addGenerator(VX2);
	  Cube->addGenerator(VX3); Cube->addGenerator(VX4);
