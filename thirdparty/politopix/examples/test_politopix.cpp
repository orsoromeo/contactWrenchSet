...
void callPolitopix(){
	  ...
	  VX0->setCoordinate(0, 0.0); VX0->setCoordinate(1,0.0); VX0->setCoordinate(2, 0.0);
	  VX1->setCoordinate(0, 0.0); VX1->setCoordinate(1,0.0); VX1->setCoordinate(2, 0.0);
	  VX2->setCoordinate(0, 0.0); VX2->setCoordinate(1,0.0); VX2->setCoordinate(2, 0.0);
	  VX3->setCoordinate(0, 0.0); VX3->setCoordinate(1,0.0); VX3->setCoordinate(2, 0.0);
	  ...
	  VX0->setCoordinate(3, 0.5);VX0->setCoordinate(4, 0.5);VX0->setCoordinate(5, 0.0);
	  VX1->setCoordinate(3, 0.0); VX1->setCoordinate(4, 0.0); VX1->setCoordinate(5, 0.0);
	  VX2->setCoordinate(3, 0.0); VX2->setCoordinate(4, 0.0); VX2->setCoordinate(5, 0.0);
	  VX3->setCoordinate(3, 1.0); VX3->setCoordinate(4, 0.0); VX3->setCoordinate(5, 0.0);
	  VX4->setCoordinate(3, 1.0); VX4->setCoordinate(4, 0.0); VX4->setCoordinate(5, 0.0);
	  VX5->setCoordinate(3, 0.0); VX5->setCoordinate(4, 1.0); VX5->setCoordinate(5, 0.0);
	  VX6->setCoordinate(3, 0.0); VX6->setCoordinate(4, 1.0); VX6->setCoordinate(5, 0.0);
	  VX7->setCoordinate(3, 1.0); VX7->setCoordinate(4, 1.0); VX7->setCoordinate(5, 0.0);
	  VX8->setCoordinate(3, 1.0); VX8->setCoordinate(4, 1.0); VX8->setCoordinate(5, 0.0);
