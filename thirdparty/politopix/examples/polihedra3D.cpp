...
void callPolitopix(){
	  ...
	  boost::shared_ptr<PolyhedralCone_Rn> LF_cone(new PolyhedralCone_Rn());
	  boost::shared_ptr<PolyhedralCone_Rn> LH_cone(new PolyhedralCone_Rn());
	  boost::shared_ptr<PolyhedralCone_Rn> RF_cone(new PolyhedralCone_Rn());
	  boost::shared_ptr<PolyhedralCone_Rn> RH_cone(new PolyhedralCone_Rn());
...
//	  boost::shared_ptr<Polytope_Rn> CWS_tmp(new Polytope_Rn());
//	  politopixAPI::computeMinkowskiSumOfPolytopes(LF_cone, LH_cone, CWS_tmp);
//	  politopixAPI::computeMinkowskiSumOfPolytopes(RF_cone, CWS_tmp, CWS_tmp);
//	  politopixAPI::computeMinkowskiSumOfPolytopes(RH_cone, CWS_tmp, CWS);
...
//      check_point->setCoordinate(2, 3.0);
